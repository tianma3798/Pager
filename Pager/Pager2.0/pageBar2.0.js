...
(function ($) {
    ...
    var PageBar = function (elem, opts) {
        ...
        var defaults = {
            ...
            pageSize: 5,//每页数据量
            numberCount: 5,//显示按钮个
            showType: 'default',// 分页控件样式控制 ，default--默认样式 棕黄色,'greenPager'---新版绿色
            pageCount: 10,//总页数
    ...
    PageBar.prototype = {
        ...
        init: function () {
            ...
            if (opts.showType == 'greenPager')
                elem.addClass('greenPager');
            //左侧数字按钮
        ...
        getRightBtn: function () {
            ...
            else if (_opts.showType == 'greenPager') {
                var pageBar_Go = getDivByClass('pageBar_Go');
        ...
        //上一组
        goToLeftGroup: function () {
            var min = this.getMinNumber();
            this.goToNumber(min - 1);
        },
        //下一组
        goToRightGroup: function () {
            var max = this.getMaxNumber();
            this.goToNumber(max + 1);
        },
        //跳转到指定页
